...
To use sbt-revolver-rollup:
    ...
    addSbtPlugin("com.malliina" % "sbt-revolver-rollup" % "1.6.51")

To use sbt-bundler:

    addSbtPlugin("com.malliina" % "sbt-bundler" % "1.6.51")

To publish to Maven Central:

    addSbtPlugin("com.malliina" % "sbt-utils-maven" % "1.6.51")
    
The Node.js plugin:

    addSbtPlugin("com.malliina" % "sbt-nodejs" % "1.6.51")

To use sbt-filetree:

    addSbtPlugin("com.malliina" % "sbt-filetree" % "1.6.51")
